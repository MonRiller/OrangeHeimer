...
sshpass -p 0rangel4nd ssh -Nf missileadmin@localhost -M -S ~/.ssh/masterSock -L 127.0.0.1:4200:172.31.86.120:8080
...
sshpass -p 0rangel4nd ssh -Nf missileadmin@localhost -S ~/.ssh/masterSock -R 172.100.0.1:4242:127.0.0.1:4201
...
sshpass -p 0rangel4nd ssh -Nf missileadmin@localhost -S ~/.ssh/masterSock -R 172.100.0.1:4243:127.0.0.1:4202
